...
namespace Hacker_News_API.Controllers
{
    ...
    public class MyHackerNewsController : ControllerBase
    {
        ...
        /// <summary>
        /// Read Configuration of number of stories retrieved
        /// </summary>
        ...
        public MyHackerNewsController(IHackerNewsService newsService, IConfiguration configuration)
        {
            ...
            if (!int.TryParse(configuration["ServiceParameters:ReturnBestStories"], out _numberOfStories))
                throw new ApplicationException("ServiceParameters:ReturnBestStories not defined or not a valid number in configuration");
        ...
        // GET api/values
        /// <summary>
        /// Return x BestStories based on number set by configuration on AppSettings
        /// </summary>
        /// <returns></returns>
        [HttpGet]
